<div class="row">
	<div class="col border-right" style="padding-right:15px; ">
	  ...
	  <div class="form-group row">
	    ...
	    <div class="col-sm-8">
	      <input type="number" class="form-control form-control-sm" id="staticEmail" value="email@example.com">
	    </div>
	  </div>
	  <div class="form-group row">
	    <label for="inputPassword" class="col-sm-4 col-form-label col-form-label-sm">Prices</label>
	    <div class="col-sm-8">
	      <input type="number" class="form-control form-control-sm" id="inputPassword" placeholder="Password">
	    </div>
	  </div>
	  ...
	  <button class="btn btn-block btn-outline-info">Buy</button>
	</form>
	</div>
	<div class="col" style="padding-left:15px; ">
	  ...
	  <button class="btn btn-block btn-outline-primary">Sell</button>
	</form>
	</div>
</div>